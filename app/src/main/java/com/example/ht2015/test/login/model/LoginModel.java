package com.example.ht2015.test.login.model;
...
public class LoginModel {
    ...
    public void updateDependentViews(boolean isExistingUserChecked) {
        if (isExistingUserChecked) {
            ...
            loginOrCreateButtonText.set(mResources.getString(R.string.action_sign_in));
        }
        else {
            emailBlockVisibility.set(View.VISIBLE);
            loginOrCreateButtonText.set(mResources.getString(R.string.action_sign_in_short));
        }
    }
